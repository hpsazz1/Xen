...
接管后继续核验新鲜人物观测，目标消失或跟踪观测过期即清理并归还移动。仅准星离框、离开扳机缩小区域或换方向键，
但仍有有效人物观测时，不作为目标消失处理。清理确认后，若允许键仍按住且目标恢复，重新核验并建立新的急停，
...
准星处于人物范围用于首次准入；接管后目标消失或跟踪观测过期会归还移动，目标恢复后可在持续持键下重新准入。
