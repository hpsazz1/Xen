...
当前 XUDP CPU JPEG Sender 在请求 120/240 FPS 时实际接收约 87/131 FPS，协议帧号、分片、几何
和哈希计数均正常，但吞吐尚未达到请求档；裸 UDP 约 60 FPS 且没有严格帧号/完整性语义。因此
NDI 是当前低延迟首选，XUDP 是完整性优先和待优化方案，裸 UDP 仅作兼容。详细证据见本地文档
