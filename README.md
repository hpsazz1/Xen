...
显式请求和反向制动过程最多 500 毫秒；独立模式在零软件键确认后，只要允许键、焦点和新鲜目标仍有效就保持物理方向键屏蔽。
任何条件失效即归还；已在途设备应答可能推迟实际清理，不能视作硬实时保证。
...
准星离开人物范围、失去目标或图像过期会取消；持续按住且目标有效时，制动后保持屏蔽，不重复反向制动。估算完成不证明停稳。
